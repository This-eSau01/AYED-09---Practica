...
public class LinkedBST<E extends Comparable<E>> implements BinarySearchTree<E> {
    ...
    // b) countAllNodes — todos los nodos
    ...
    // c) countNodes — solo nodos NO-hoja
    ...
    // d) height(x) — iterativo con Queue (BFS)
    ...
    // e) amplitude — número máximo de nodos en un nivel (usa BFS)
