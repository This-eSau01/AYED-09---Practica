...
public class LinkedBST<E extends Comparable<E>> implements BinarySearchTree<E> {
    ...
    // parenthesize — representación entre paréntesis con sangría
    // Usa Queue propia (sin Stack de Java) — solo estructuras propias permitidas
    public void parenthesize() {
        if (isEmpty()) { System.out.println("()"); return; }
        parenthesizeRec(root, 0);
    }
    private void parenthesizeRec(Node node, int depth) {
        if (node == null) return;
    ...
    // isValidBST — verifica propiedad BST sin reconstruir, con recorrido DFS
